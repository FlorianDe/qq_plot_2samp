...
from .typing import PlotData, PlotOptions, PlotResult, Point, Locale
...
__PLOT_DICT: dict[__Keys, dict[Locale, str]] = {
    ...
    __Keys.LBL_THEORETICAL_LINE: {
        Locale.EN: "Theoretical line",
        Locale.DE: "Theoretische Linie"
    },
    __Keys.Y_LABEL_DEFAULT: {
        Locale.EN: "Sampled Values",
        Locale.DE: "Stichproben"
    },
    __Keys.X_LABEL_DEFAULT: {
        Locale.EN: "Theoretical Quantiles",
        Locale.DE: "Theoretischen Quantile"
    },
}
...
def draw_qq_plot(
    ...
    # Plot extra quantile points if specified
